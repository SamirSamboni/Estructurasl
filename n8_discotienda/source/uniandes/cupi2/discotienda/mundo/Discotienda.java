...
public class Discotienda
{
	...
	/**
	 * @author Victor Posso- Samir Samboni
	 * Generar un informe de todos los discos de un género ROCK y POP y que además sean económicos,
	 *  es decir que el precio total NO supere los (1000) mil pesos.
	 *   El informe debe tener todos los datos de los discos si cumple con las condiciones.
	 * @throws FileNotFoundException Si no existen discos con esas condiciones se debe lanzar una excepción 
	 * es decir que los discos de dichos generos no superen los 1000 pesos 
	 */


	public void InformeDiscos () throws FileNotFoundException 
	{
		...
		// Variable para verificar si se encontraron discos que cumplan con las condiciones
		...
		for (int i=0;i<discos.size();i++) 
		{
			...
			// Verificar si el género del disco es ROCK o POP y si el precio no supera los 1000 pesos
			if ((miDisco.darGenero().equalsIgnoreCase("ROCK") || miDisco.darGenero().equalsIgnoreCase("POP")) &&
					miDisco.darPrecioDisco() < 1000) 
			{
				// Marcar que se encontraron discos que cumplen con las condiciones
				encontrados = true;
				// Escribir la información del disco en el informe
	...
	/**
	 * Genera un informe de discos que cumplan con las condiciones de género y precio económico.
	 *
	 * @return Un mensaje indicando si el reporte se generó con éxito o si ocurrió un error.
	 */
	public String metodo2( )
	{
		try {
			// Llama al método para generar el informe de discos
			InformeDiscos();
